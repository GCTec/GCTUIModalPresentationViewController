...
Pod::Spec.new do |s|
  s.name         = "GCTUIModalPresentationViewController"
  s.version      = "0.0.1"
  ...
  s.homepage     = "https://github.com/GCTec/GCTUIModalPresentationViewController"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author             = { "Later" => "lshxin89@126.com" }
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/GCTec/GCTUIModalPresentationViewController.git", :tag => s.version }
